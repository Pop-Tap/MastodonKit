...
class AttachmentTests: XCTestCase {
    func testAttachmentFromJSON() {
        ...
        XCTAssertEqual(attachment?.previewUrl?.absoluteString, "http://lorempixel.com/200/200/cats/4/")
        XCTAssertEqual(attachment?.textUrl?.absoluteString, "https://mastodon.technology/@ornithocoder")
